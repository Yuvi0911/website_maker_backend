// is file ki help se user jo prompt dega website bnane k liye us prompt k saath ye extra prompt add hoga jiske website beautiful bnegi aur jo code h vo alag alag file ki form me divide ho kr aaye ga jaise ki package.json, app.ts, etc.
